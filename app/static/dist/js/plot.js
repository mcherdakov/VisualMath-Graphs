(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["sheckley"] = factory();
	else
		root["sheckley"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libsD3D3 = __webpack_require__(1);

	var _libsD3D32 = _interopRequireDefault(_libsD3D3);
	...
	var _Plotter = __webpack_require__(5);

	var _Plotter2 = _interopRequireDefault(_Plotter);

	var _OverContainer = __webpack_require__(37);
	...
	var PlotContainer = (function () {
	  ...
	  _createClass(PlotContainer, [{
	    ...
	    value: function addPlot(options) {
	      ...
	      var plotter = new _Plotter2['default'](id, options);
	    ...
	    value: function addEmptyDiv() {
	      ...
	      _libsD3D32['default'].select('#' + this.id).append('div').attr('id', newDivId);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCoffee = __webpack_require__(6);

	var _PlotPureCoffee = __webpack_require__(7);

	var _PlotPureCoffee2 = _interopRequireDefault(_PlotPureCoffee);

	var _PlotCoffee = __webpack_require__(8);

	var _PlotCoffee2 = _interopRequireDefault(_PlotCoffee);

	var _PointCoffee = __webpack_require__(26);

	var _PointCoffee2 = _interopRequireDefault(_PointCoffee);

	var _PointPureCoffee = __webpack_require__(28);

	var _PointPureCoffee2 = _interopRequireDefault(_PointPureCoffee);

	var _FuncCoffee = __webpack_require__(29);

	var _FuncCoffee2 = _interopRequireDefault(_FuncCoffee);

	var _FuncPureCoffee = __webpack_require__(30);

	var _FuncPureCoffee2 = _interopRequireDefault(_FuncPureCoffee);

	var _ParametricArrayCoffee = __webpack_require__(31);

	var _ParametricArrayCoffee2 = _interopRequireDefault(_ParametricArrayCoffee);

	var _ParametricArrayPureCoffee = __webpack_require__(32);

	var _ParametricArrayPureCoffee2 = _interopRequireDefault(_ParametricArrayPureCoffee);

	var _LineCoffee = __webpack_require__(33);

	var _LineCoffee2 = _interopRequireDefault(_LineCoffee);

	var _LinePureCoffee = __webpack_require__(34);

	var _LinePureCoffee2 = _interopRequireDefault(_LinePureCoffee);

	var _ShadedAreaCoffee = __webpack_require__(35);

	var _ShadedAreaCoffee2 = _interopRequireDefault(_ShadedAreaCoffee);

	var _WrapCoffee = __webpack_require__(4);

	var _WrapCoffee2 = _interopRequireDefault(_WrapCoffee);

	var _ParametricFuncCoffee = __webpack_require__(36);

	var _ParametricFuncCoffee2 = _interopRequireDefault(_ParametricFuncCoffee);
	...
	var Plotter = (function () {
	  function Plotter(elementID, options) {
	    ...
	    (0, _utilsCoffee.extend)(this, options);
	    if (!this.communicate) {
	    ...
	    this.id = elementID;
	    this.emitter = (0, _eventEmitter2['default'])(this);

	    this.plot = new _PlotCoffee2['default'](this.id, new _PlotPureCoffee2['default'](options), options);
	    this.plot.emitter.on('draw', function () {
	      _this.draw();
	      if (_this.plot.onDrawCallback) {
	        _this.plot.onDrawCallback(_this.plot);
	      }
	    });
	  ...
	  _createClass(Plotter, [{
	    ...
	    key: 'addPoint',
	    value: function addPoint(x, y, options) {
	      var pure = arguments.length === 3 || arguments.length === 2 ? new _PointPureCoffee2['default'](x, y, options) : x;

	      var point = new _PointCoffee2['default'](pure, this.plot.graph, this.plot.x, this.plot.y, options);
	    ...
	    key: 'point',
	    value: function point(x, y, options) {
	    ...
	    value: function addFunc(func) {
	      ...
	      var funcObject = undefined;
	      if (func.model === 'Func') {
	        funcObject = new _FuncCoffee2['default'](func, this.plot.graph, this.plot.x, this.plot.y, options);
	      } else {
	        var pure = new _FuncPureCoffee2['default'](func, options);
	        funcObject = new _FuncCoffee2['default'](pure, this.plot.graph, this.plot.x, this.plot.y, options);
	      }
	    ...
	    key: 'func',
	    value: function func(_func, options) {
	      return this.addFunc(_func, options);
	    }
	  }, {
	    key: 'addArea',
	    value: function addArea(array, options) {
	      var area = undefined;
	      if (array.model === 'ParametricArray') {
	        area = new _ParametricArrayCoffee2['default'](array, this.plot.graph, this.plot.x, this.plot.y, options);
	      } else {
	        var pure = new _ParametricArrayPureCoffee2['default'](array, options);
	        area = new _ParametricArrayCoffee2['default'](pure, this.plot.graph, this.plot.x, this.plot.y, options);
	      }
	    ...
	    key: 'area',
	    value: function area(array, options) {
	      return this.addArea(array, options);
	    }
	  }, {
	    key: 'addShadedArea',
	    value: function addShadedArea(func) {
	      var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	      options.accuracy = options.accuracy || this.plot.width;

	      var localOptions = {};
	      var pureFunc = undefined;
	      if ((0, _utilsCoffee.isFunction)(func) || func.model === 'Func') {
	        (0, _utilsCoffee.extend)(localOptions, options);
	        pureFunc = func;
	      } else if ((0, _utilsCoffee.isFunction)(func.pure.getFunc())) {
	        var keys = function keys(object) {
	          _(object).keys().difference(_ShadedAreaCoffee2['default'].prototype.defaults.ownDefaults).value();
	        };

	        (0, _utilsCoffee.extend)(localOptions, (0, _utilsCoffee.pick)(func, keys(_FuncCoffee2['default'].prototype.defaults)));
	        (0, _utilsCoffee.extend)(localOptions, (0, _utilsCoffee.pick)(func.pure, keys(_FuncPureCoffee2['default'].prototype.defaults)));
	        pureFunc = func.pure.getFunc();
	      } else {
	        var ex = 'shadedArea: �������� ��� ��������� func.';
	        ex += ' ������ ���� Function ��� Func.';
	        throw new Exception(ex);
	      }

	      var pure = new _FuncPureCoffee2['default'](pureFunc, localOptions);
	      var obj = new _ShadedAreaCoffee2['default'](pure, this.plot.graph, this.plot.x, this.plot.y, localOptions);
	      this.elements.add(obj);
	      return obj;
	    }
	  }, {
	    key: 'shadedArea',
	    value: function shadedArea(func, options) {
	      return this.addShadedArea(func, options);
	    }
	  }, {
	    key: 'addParametricFunc',
	    value: function addParametricFunc(array, options) {
	      var pure = new _ParametricArrayPureCoffee2['default'](array, options);
	      var parametricFunc = new _ParametricFuncCoffee2['default'](pure, this.plot.graph, this.plot.x, this.plot.y, options);
	    ...
	    key: 'parametricFunc',
	    value: function parametricFunc(array, options) {
	      return this.addParametricFunc(array, options);
	    }
	  }, {
	    key: 'addLine',
	    value: function addLine(x1, y1, x2, y2, options) {
	      var pure = undefined;
	      if (arguments.length === 4 || arguments.length === 5) {
	        pure = new _LinePureCoffee2['default']({ x1: x1, y1: y1, x2: x2, y2: y2 }, options);
	      } else if (arguments.length === 1) {
	        pure = x1;
	      }

	      var line = new _LineCoffee2['default'](pure, this.plot.graph, this.plot.x, this.plot.y, options);
	    ...
	    value: function remove(element) {
	      var removedElement = this.elements.remove(element);
	    ...
	    value: function setModel(model) {
	      ...
	      if (!this.elements.empty()) {
	        this.elements.each(function (el, i) {
	          return el.setModel(model.elements[i], { silent: true });
	        });
	      } else {
	        model.elements.forEach(function (el) {
	          return _this2[el.model](el);
	        });
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Plot, PlotPure, SavePng, SaveSvg, _, d3, ee;
	...
	SaveSvg = __webpack_require__(24);

	SavePng = __webpack_require__(25);

	PlotPure = __webpack_require__(7);
	...
	Plot = (function() {
	  ...
	  Plot.prototype.draw = function() {
	    var gx, gxe, gy, gye, ref, ref1, xTicks, yTicks;
	    ref = this.x.domain(), this.pure.left = ref[0], this.pure.right = ref[1];
	    ref1 = this.y.domain(), this.pure.bottom = ref1[0], this.pure.top = ref1[1];
	  ...
	  Plot.prototype.saveSvg = function() {
	    return SaveSvg(this.id);
	  };

	  Plot.prototype.savePng = function() {
	    return SavePng(this.id);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SaveSvg = function SaveSvg(id) {
	            var xml = d3.select(id).select("svg").attr("version", 1.1).attr("xmlns", "http://www.w3.org/2000/svg").node().outerHTML;
	            var imgsrc = 'data:image/svg+xml;base64,' + btoa(unescape(encodeURIComponent(xml)));
	            var a = d3.select('body').append("a").attr('download', 'graph.svg').attr('href', imgsrc).node().click();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SavePng = function SavePng(id) {
	  ...
	  var image = new Image();
	  image.src = imgsrc;
	  canvas.attr('width', d3.select('svg').attr('width'));
	  canvas.attr('height', d3.select('svg').attr('height'));
	  ...
	  var a = d3.select('body').append('a').attr('download', 'graph.png').attr('href', canvasdata).node().click();
	  canvas.remove();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Colors, Colours, Point, PointPure, _, d3;

	d3 = __webpack_require__(1);

	_ = __webpack_require__(2);

	Colors = __webpack_require__(27)('Color');

	Colours = __webpack_require__(27)('Colour', 'color');

	PointPure = __webpack_require__(28);
	...
	Point = (function() {
	  ...
	  Point.prototype.draw = function(graph, linearX, linearY) {
	    ...
	    if ((linearX != null) && (linearY != null)) {
	      ref = [linearX, linearY], this.linearX = ref[0], this.linearY = ref[1];
	    }
	    return this.update();
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Colors, Colours, Fill, Func, FuncPure, _, d3;
	...
	Fill = __webpack_require__(27)('Fill');

	FuncPure = __webpack_require__(30);
	...
	Func = (function() {
	  ...
	  function Func(functionPure, graph, linearX, linearY, options) {
	    ...
	    this.el = [];
	    for (i = j = 0, ref = this.breaks.length; 0 <= ref ? j <= ref : j >= ref; i = 0 <= ref ? ++j : --j) {
	      path = this.g.append('path').classed('function', true);
	      this.el.push(path);
	      i;
	    }
	    if ((linearX != null) && (linearY != null)) {
	      ref1 = [linearX, linearY], this.linearX = ref1[0], this.linearY = ref1[1];
	    }
	    this.update();
	  }
	  ...
	  Func.prototype.update = function(pointsArray) {
	    var el, i, j, left, len, points, ref, ref1, results, right;
	    ref = [this.left(), this.right()], left = ref[0], right = ref[1];
	    ...
	    for (i = j = 0, len = ref1.length; j < len; i = ++j) {
	      ...
	      results.push(el.attr('d', this.path(points)).attr('fill', this.Fill()).attr('fill-opacity', this.fillOpacity).attr('stroke-width', this.strokeWidth).attr('stroke', this.Color()));
	    }
	    return results;
	  };
	  ...
	  Func.prototype.moveTo = function(func, options) {
	    var delay, duration, el, i, j, len, ref, results;
	    if (options == null) {
	      options = {};
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Colors, Colours, Fill, ParametricArray, ParametricArrayPure, _, d3;
	...
	ParametricArrayPure = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Colors, Colours, Line, LinePure, _, d3;
	...
	LinePure = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	ShadedArea = (function(superClass) {
	  extend(ShadedArea, superClass);
...
/***/ function(module, exports, __webpack_require__) {
	...
	ParametricArray = __webpack_require__(31);

	ParametricFunc = (function(superClass) {
	  extend(ParametricFunc, superClass);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GateCoffee = __webpack_require__(38);
